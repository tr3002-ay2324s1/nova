...
DAY_END_TIME = time(hour=23, minute=0, second=0, tzinfo=NEW_YORK_TIMEZONE_INFO)
get_current_datetime = lambda: datetime.now(tz=NEW_YORK_TIMEZONE_INFO) + timedelta(hours=0, minutes=4, seconds=20)
